...
\begin{center}
    \textsc{https://github.com/Mitchell-D/aes670hw2/}
\end{center}
...
\begin{itemize}
    ...
    \item{All classification and filtering algorithms, with standardized inputs and outputs.}
    ...
    \item{Generalized methods for plotting data in a variety of formats (histograms, heatmaps, projected rasters, raw images, etc).}
\end{itemize}
